...
?>
<?php
 include_once '../controlador/VerStatuspedController.php';
?>
<html>
...
$sta='Pendiente/s';
 ...
 <h1 class="all2">Número de <b class="pes">Pedidos <?php echo $sta ?></b>: <?php echo $resultadocont ?> resultado/s encontrado/s.</h1>
            <?php
